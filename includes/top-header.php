     ...
     <br>
      ...
      <i class="fa fa-user d-flex align-items-center ms-4">
        ...
        <i class="bi bi-shopping-cart d-flex align-items-center ms-4">
          <a id="texto"href="my-cart.php">Mi Carrito</a></i>
...
-->
          ...
          <li><form name="search" method="post" action="busqueda_resultado.php">
...
<style>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form name="search" method="post" action="busqueda_resultado.php">
