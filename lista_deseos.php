									...
									<tbody>
										...
										?>
												...
												<tr>
													...
													<td class="col-md-6">
														<div class="product-name"><a id="name" href="product-details.php?pid=<?php echo htmlentities($pd = $row['pid']); ?>"><?php echo htmlentities($row['pname']); ?></a></div>
														...
														?>
															...
															<div class="rating">
																...
																<span class="review">( <?php echo htmlentities($num); ?> Comentarios )</span>
															</div>
														<?php } ?>
														<div class="price">S/.
													...
													<td class="col-md-2">
														<a id="a" href="lista_deseos.php?page=product&action=add&id=<?php echo $row['pid']; ?>" class="btn-upper btn btn-primary">AGREGAR AL CARRITO</a>
													</td>
													<td class="col-md-2 close-btn">
														<a href="lista_deseos.php?del=<?php echo htmlentities($row['wid']); ?>" onClick="return confirm('Are you sure you want to delete?')" class=""><i class="fa fa-times"></i></a>
													</td>
												</tr>
											<?php }
										} else { ?>
