...
?>
		...
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Dirección de Correo Electronico <span>*</span></label>
		...
		<div class="radio outer-xs">
		  	<a id="contraseña" href="forgot-password.php" class="forgot-password pull-right">¿Olvidaste Tu Contraseña</a>
		</div>
...
<div class="form-group">
		...
		<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2">Dirección de Correo Electronico<span>*</span></label>
...
<div class="form-group">
	...
	<div class="checkbox">
		  ...
		  Acelere su camino a través de la caja.
		</label>
		<label class="checkbox">
		Realice un seguimiento de sus pedidos fácilmente.
		</label>
		<label class="checkbox">
		Mantenga un registro de todas sus compras.
		</label>
	</div>
</div>	
