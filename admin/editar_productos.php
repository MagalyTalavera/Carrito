...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="actualizar_img1.php?id=<?php echo $row['id'];?>">Cambiar Imagen</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="actualizar_img2.php?id=<?php echo $row['id'];?>">Cambiar Imagen</a>
</div>
</div>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="actualizar_img3.php?id=<?php echo $row['id'];?>">Cambiar Imagen</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
