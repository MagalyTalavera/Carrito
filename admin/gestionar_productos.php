...
?>									
										<tr>
											...
											<td>
											<a href="editar_productos.php?id=<?php echo $row['id']?>" ><i class="icon-edit"></i></a>
											<a href="gestionar_productos.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estás seguro de que quieres eliminar?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
