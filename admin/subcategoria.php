...
if(isset($_GET['del']))
		  {
                  ...
                  $_SESSION['delmsg']="SubCategoria Eliminada !!";
		  }
...
<head>
	...
	<title>Admin| Sub Categoria</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nombre de la Sub Categoria</label>
<div class="controls">
<input type="text" placeholder="Ingrese el nombre de la sub Categoria"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estás seguro de que quieres eliminar?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
