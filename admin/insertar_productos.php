...
$_SESSION['msg']="Producto insertado exitosamente!!";
...
<head>
	...
	<title>Admin| Insertar Productos</title>
...
{?>
									...
									<strong>Excelente!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="controls">
<input type="text"    name="productName"  placeholder="Ingrese el nombre del producto" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Ingrese la marca del Producto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingrese el precio del producto" class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Precio del producto después del descuento (precio de venta)
</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Ingrese la Descripcion del Producto" rows="6" class="span8 tip">
</textarea>  
</div>
</div>
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingrese el costo de envio " class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen del producto3</label>
<div class="controls">
