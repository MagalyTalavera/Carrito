									...
									<div class="item">
										<div class="products">
											...
											<div class="product-info text-left m-t-20">
												<h3 class="name"><a id="nombres"href="product-details.php?pid=<?php echo htmlentities($rws['id']); ?>"><?php echo htmlentities($rws['productName']); ?></a></h3>
						...
						<div class="row  wow fadeInUp">
							...
							<div class='col-sm-6 col-md-7 product-info-block'>
								<div class="product-info">
									<h1 id="nombre" class="name"><?php echo htmlentities($row['productName']); ?></h1>
    ...
    background-color: #106eea !important;
									...
									<div class="quantity-container info-container">
										<div class="row">
											...
											<div class="col-sm-7">
												<?php if ($row['productAvailability'] == 'In Stock') { ?>
													<a id="agregar" href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> AGREGAR AL CARRITO</a>
												<?php } else { ?>
